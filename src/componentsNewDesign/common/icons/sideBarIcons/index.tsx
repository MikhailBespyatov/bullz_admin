...
import blockedUsersIconImg from 'assets/icons/sideBarIcons/blocked_icon.svg';
...
import topicsIconImg from 'assets/icons/sideBarIcons/topics_icon.svg';
...
export const DeletedUsersIcon = ({ active, isExpanded }: Props) => (
    <OpacityActiveEffect active={active}>
        <AdaptiveWrapper isExpanded={isExpanded}>
...
export const BlockedUsersIcon = ({ active, isExpanded }: Props) => (
    <OpacityActiveEffect active={active}>
        <AdaptiveWrapper isExpanded={isExpanded}>
            <CustomImg height="19px" src={blockedUsersIconImg} width="17px" />
        </AdaptiveWrapper>
    </OpacityActiveEffect>
);
...
export const TopicsIcon = ({ active, isExpanded }: Props) => (
    <OpacityActiveEffect active={active}>
        <AdaptiveWrapper isExpanded={isExpanded}>
            <CustomImg height="18px" src={topicsIconImg} width="20px" />
        </AdaptiveWrapper>
    </OpacityActiveEffect>
);
