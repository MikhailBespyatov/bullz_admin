...
import {
    ...
    titleMarginBottom
} from 'componentsNewDesign/common/inputs/TrendingsSelect/constants';
import {
    ...
    SelectWrapperProps,
    TitleSpan
} from 'componentsNewDesign/common/inputs/TrendingsSelect/styles';
        ...
        <>
            ...
            >
                <Column ref={selectRef} width="100%">
                    {title && (
                        <Row marginBottom={isMobile ? '8px' : titleMarginBottom}>
