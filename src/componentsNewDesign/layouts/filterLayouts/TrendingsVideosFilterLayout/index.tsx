...
import { TrendingsDateRangePicker } from 'componentsNewDesign/common/inputs/TrendingsDateRangePicker';
...
import {
    ...
    selectorWidth
} from 'componentsNewDesign/layouts/filterLayouts/TrendingsVideosFilterLayout/constants';
...
export const TrendingsVideosFilterLayout: FC<Props> = ({ totalRecords, children, withoutFooter }) => {
    const {
        pageIndex,
        limit,
        // searchText,
